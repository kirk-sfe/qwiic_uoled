...
public:
	// Constructor(s)
	MicroOLED(uint8_t address = I2C_ADDRESS_SA0_1); 

	bool begin(void); // Needed for backward-compatibility

	void print(const char * str);
	void print(int number);	
	int write(uint8_t c); // Virtual - for I2C _or_ SPI
	...
	void drawIcon(uint8_t locationX, uint8_t locationY, uint8_t iconWidth, uint8_t iconHeight, uint8_t *bitArray, uint8_t arraySizeInuint8_ts, bool overwrite = false);
